...
let Book = {
  //Властивості об'єкта Book
  title: "Загальна книга",
  author: "Анонім",
  pages: 0,

  //функція read() у властивості read
  read: function () {
...
console.log("Виклик функції read об'єкту Book:");
Book.read();
...
let Novel = Object.create(Book); // Наслідуємо властивості і функції від об'єкта Book
...
Object.defineProperty(ScienceBook, "info", {
  ...
  writable: false, // Забороняємо зміну властивості, ставиться по замовченості
  configurable: false, // Забороняємо видалення властивості,ставиться по замовченості
});

// Отримаємо помилку Cannot assign to read only property 'info' of object '#<Object>
//ScienceBook.info = "Привіт";
...
//ScienceBook.info = "написана в 1915 році"; //Вже створене!
...
let Textbook = Object.create(ScienceBook)
  ...
  Object.defineProperty(Textbook, "read()", {
    set(value) {
      this._read() = value;
    },
